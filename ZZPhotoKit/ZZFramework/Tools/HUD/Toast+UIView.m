...
- (CGPoint)centerPointForPosition:(id)point withToast:(UIView *)toast {
    if([point isKindOfClass:[NSString class]]) {
        ...
        if([point caseInsensitiveCompare:@"top"] == NSOrderedSame) {
            ...
            return CGPointMake(self.bounds.size.width / 2, self.bounds.size.height - self.bounds.size.height / 3);
        }
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        CGSize expectedSizeTitle = [title sizeWithAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIFont boldSystemFontOfSize:CSToastFontSize],NSFontAttributeName, nil]];
    ...
    if (message != nil) {
        ...
        CGSize expectedSizeMessage = [message sizeWithAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIFont systemFontOfSize:CSToastFontSize],NSFontAttributeName, nil]];
