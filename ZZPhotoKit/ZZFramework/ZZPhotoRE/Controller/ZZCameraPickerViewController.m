...
@interface ZZCameraPickerViewController()<UICollectionViewDelegate,UICollectionViewDataSource,ZZCameraFocusDelegate>
...
-(void)setupCollectionViewUI
{
    ...
    _picsCollection = [[UICollectionView alloc]initWithFrame:CGRectMake(10, ZZ_VH - 74 - photoSize, ZZ_VW - 20, photoSize) collectionViewLayout:flowLayout];
